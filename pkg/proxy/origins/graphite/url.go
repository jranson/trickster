...
// FastForwardRequest is not used for Graphite and is here to conform to the Proxy Client interface
func (c *Client) FastForwardRequest(r *http.Request) (*http.Request, error) { return nil, nil }
