		...
		case "trq":
			if dc.IsNil() {
				...
				if z.TimeRangeQuery == nil {
					z.TimeRangeQuery = new(TimeRangeQuery)
				}
...
func (z *DataSet) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 6
	// write "status"
	err = en.Append(0x86, 0xa6, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73)
	if err != nil {
		return
	}
	...
	// write "output_format"
	err = en.Append(0xad, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74)
	if err != nil {
		return
	}
...
func (z *DataSet) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 6
	// string "status"
	o = append(o, 0x86, 0xa6, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73)
	...
	o = append(o, 0xad, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74)
